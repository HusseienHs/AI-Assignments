(define (problem epic-battle1)
  (:domain epicBattle)
  (:objects
    cell1 cell2 cell3 cell4 cell5 cell6 cell7 cell8 cell9 cell10 cell11 cell12 cell13 cell14 cell15 cell16  - cell
  ...
  (:init
    ...
    (position potionMaster cell11)
    (position sword1 cell6)
    (position wand1 cell13)
    (position potionBook1 cell9)
    (position evilDragon cell16)
  )
  (:goal
    (and
      (vanquished-dragon)
